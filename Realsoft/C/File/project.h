...
//Function to delete all trade contents 
void TRDdel()
{
    freopen("TRD.dat", "wb", ft);
    freopen("TRD.dat", "r + b", ft);
}

//Function to delete all city contents
void CTYdel()
{
    freopen("CTY.dat", "wb", fc);
    freopen("CTY.dat", "r + b", fc);
}

//Function to delete all Student Contents
void STUdel()
{
    freopen("STU.dat", "wb", fs);
    freopen("STU.dat", "r + b", fs);
}